...
export const metadata: Metadata = {
  ...
  description:
    "¿Buscas Clinera opiniones? Lee el testimonio de Katherine Meza, partner de Clinera en Chile: agenda, seguimiento y operación clínica sin perder pacientes.",
  keywords: [
    "clinera opiniones",
  ...
  openGraph: {
    ...
    description:
      "Partner de Clinera en Chile. Katherine Meza explica por qué recomienda la plataforma y qué encontrarías si buscas Clinera opiniones.",
  ...
  "@graph": [
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "¿Hay opiniones sobre Clinera?",
          acceptedAnswer: {
            "@type": "Answer",
      ...
      <main className="section-pad mx-auto max-w-3xl py-12 md:py-16">
        ...
        <article className="mt-10 space-y-5 text-[1.05rem] leading-relaxed text-espresso">
          ...
          <h2 className="pt-2 font-display text-2xl text-negro">
            ¿Tienes una opinión o una duda sobre Clinera?
          </h2>
          <p>
